...
const NUTRIENT_INFO = {
  'Vitamin A': {
    ...
    deficiencySymptoms: ['Night blindness', 'Weakened immune system', 'Poor skin health'],
  ...
  'Vitamin C': {
    ...
    deficiencySymptoms: ['Weakened immune system', 'Slow wound healing', 'Fatigue'],
  ...
  'Vitamin D': {
    ...
    toxicitySymptoms: ['Kidney problems', 'Calcium buildup in blood', 'Confusion'],
    category: 'Fat-soluble vitamin'
  },
  'Iron': {
