const handleExportCSV = (results, selectedFoods = []) => {
  ...
  const foodData = results.food_items.map((foodName, index) => {
    ...
    const nutrients = Object.entries(food.nutrients).reduce((acc, [key, value]) => {
  ...
  foodData.forEach(food => {
    const row = [
      ...
      food.nutrients['Vitamin D (µg)']?.toFixed(2) || '0',
      ...
      food.nutrients['Vitamin B12 (µg)']?.toFixed(2) || '0',
      ...
      food.nutrients['Copper (µg)']?.toFixed(2) || '0',
